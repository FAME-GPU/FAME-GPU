...
int FAME_Set_User_Option( POPT *Popt )
{
    ...
    while(fgets(str, 100, fp) != NULL)
    {
        ...
        else if(strcmp(str, "# Permeability (inner material)") == 0)
        {
            ...
            Popt->material.mag_permeab_in = (double*) calloc(Popt->material.num_mag_permeab_in, sizeof(double));
        ...
        else if(strcmp(str, "# Reciprocity (inner material) (must given when biisotropic)") == 0)
        {
            ...
            Popt->material.reciprocity_in = (double*) calloc(Popt->material.num_reciprocity_in, sizeof(double));
        ...
        else if(strcmp(str, "# Chirality (inner material) (must given when biisotropic)") == 0)
        {
            ...
            Popt->material.chirality_in = (double*) calloc(Popt->material.num_chirality_in, sizeof(double));
